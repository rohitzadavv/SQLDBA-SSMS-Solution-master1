...
FROM  CWPUBLISHER.[DatabaseName].dbo.CreativeWork 
EXEC master.dbo.sp_addlinkedserver @server = N'CWPUBLISHER', @srvproduct=N'sql_server', @provider=N'SQLNCLI11', @datasrc=N'DbServerName' 
