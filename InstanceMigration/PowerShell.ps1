...
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.ii) Agent Category\AddCategory_Script.sql";
$dropCreate = $false;
$pass = $false;
...
<# 1.a.iii) Agent Jobs
        Script out Jobs
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.iii) Agent Jobs\1. AgentJobs_WithoutReplication&Checksum_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
$skipJobs = @('QRepl TurboP3'
,'QRepl Turbo Charge Cosmo0 Replication'
,'QR Nightly Synch'
,'DBA Track Cosmo Logging growth'
,'DBA Replication_Check'
,'DBA Set Cosmo Logging'
,'DBA Backup Replqueue'
,'DBA Backup Cosmo0 for offline dbccs'
,'TEMP_EUDummyDataCleanup'
,'TEMP_Episode_Cleanup'
,'DBA Run Trace for Perf Logging'
,'TEMP_MSBing_Cleanup'
,'zzResLink Lock Sources'
,'zzAward_Sync_For_LVs_(Temp)'
,'Episodic LV'
,'Exception program issue temp fix'
,'Reslink Gapfill'
,'Temp – Shell programs delete'
,'DBA Rebuild Cosmo0 FTCs'
,'DBA Checksumdb load'
...
<# 1.a.iii) Agent Jobs
        -- Disable
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.iii) Agent Jobs\2. AgentJobs_WithoutReplication&Checksum_Disable_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
<# 1.a.iii) Agent Jobs
        -- Enable
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.iii) Agent Jobs\3. AgentJobs_Enable_WithoutReplication&Checksum_Script.sql";
#$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.iii) Agent Jobs\3. AgentJobs_Enable_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
$Jobs | Where-Object {$_.IsEnabled -eq $false} | Select-Object Name, Category, IsEnabled | Export-Clixml -Path 'F:\SQLDBATools\Cosmo Migration\1.a.iii) Agent Jobs\DisabledJobs.xml'
Import-Clixml -Path 'F:\SQLDBATools\Cosmo Migration\1.a.iii) Agent Jobs\DisabledJobs.xml' | ft -AutoSize
# ------------------------------------------------------------------------------------------------
# ------------------------------------------------------------------------------------------------
<# 1.a.iv) Agent Operators
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.iv) Agent Operators\CreateOperators_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.ix) Credentials\Create_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.v) Agent Proxy Accounts\Create_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.vi) Agent Shared Schedules\Create_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.vii) Backup Devices\Create_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
<# 1.a.x) Custom Errors
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.x) Custom Errors\AddMessages_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
$Collection = Invoke-Sqlcmd -ServerInstance $cosmoServer -Query $sqlQuery;
foreach ($i in $Collection)
{    
...
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.xi) Database Mail\1. MailAccounts_Script.sql";
...
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.xi) Database Mail\2. Profiles_Script.sql";
...
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.xi) Database Mail\3. ConfigurationValues_Script.sql";
...
<# 1.a.xii) Endpoints
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.xii) Endpoints\Create_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
Copy-DbaLinkedServer -Source $cosmoServer -Destination $DestinationInstance;
...
# https://dbatools.io/functions/copy-dbalinkedserver/
Import-Module dbatools -DisableNameChecking;
Export-DbaLogin -SqlServer $cosmoServer -FilePath "F:\SQLDBATools\Cosmo Migration\1.a.xv) Logins\$cosmoServer-logins.sql";
...
Copy-DbaResourceGovernor -Source $cosmoServer -Destination $DestinationInstance;
...
Copy-DbaServerTrigger -Source $cosmoServer -Destination $DestinationInstance;

# or

$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.xviii) Server Triggers\Create_Script.sql";
$dropCreate = $false;
$pass = $false;
if([System.IO.File]::Exists($outputPath)) {
    Write-Host "File already exists. Pls check" -ForegroundColor DarkRed -BackgroundColor Yellow;
...
<# 1.a.xix) spConfigure
#>
$outputPath = "F:\SQLDBATools\Cosmo Migration\1.a.xix) spConfigure\Create_Script.sql";
Export-DbaSpConfigure $cosmoServer "$outputPath";
...
Copy-DbaSqlDataCollector -Source $cosmoServer -Destination $DestinationInstance
...
Copy-DbaSqlPolicyManagement -Source $cosmoServer -Destination $DestinationInstance
...
Copy-DbaSsisCatalog -Source $cosmoServer -Destination $DestinationInstance
...
Copy-DbaSysDbUserObject -Source $cosmoServer -Destination $DestinationInstance
