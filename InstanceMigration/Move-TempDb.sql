...
SELECT 'ALTER DATABASE tempdb MODIFY FILE (NAME = [' + f.name + '],'
	+ ' FILENAME = ''G:\MSSQLData\Data\' + f.name
...
GO
ALTER DATABASE [tempdb] ADD FILE ( NAME = N'tempdev4', FILENAME = N'G:\MSSQLData\Data\tempdb4.mdf' , SIZE = 20971520KB , FILEGROWTH = 1048576KB )
GO
